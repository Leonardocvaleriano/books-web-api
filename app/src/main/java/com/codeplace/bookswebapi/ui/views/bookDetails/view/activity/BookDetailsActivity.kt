...
class BookDetailsActivity: AppCompatActivity() {
   ...
   private fun initObservable(){
        viewModel.detailBookItems.observe(this){ bookDetailItems ->
    ...
    private fun initBinding(bookDetailItems:BookDetailslDto) {
        ...
        binding.txtDescriptionTitle.visibility= TextView.VISIBLE
        binding.view.visibility = TextView.VISIBLE
        binding.imgBook.visibility = TextView.VISIBLE
    }
 }